...
CoursePresent.defaultProps = {
    src: [
        {courseName : "Math101", courseImage : 'https://dummyimage.com/318x180/AAAAAA/FFFFFF&text=Default IMG',courseLink:"/course",courseDesc:"aaaaaaaa"},
        {courseName : "Math102", courseImage : 'https://dummyimage.com/318x180/AAAAAA/FFFFFF&text=Default IMG',courseLink:"/course",courseDesc:"aaaaaaaa"},
        {courseName : "Math201", courseImage : 'https://dummyimage.com/318x180/AAAAAA/FFFFFF&text=Default IMG',courseLink:"/course",courseDesc:"aaaaaaaa"},
        {courseName : "Math202", courseImage : 'https://dummyimage.com/318x180/AAAAAA/FFFFFF&text=Default IMG',courseLink:"/course",courseDesc:"aaaaaaaa"},
        {courseName : "Math202", courseImage : 'https://dummyimage.com/318x180/AAAAAA/FFFFFF&text=Default IMG',courseLink:"/course",courseDesc:"aaaaaaaa"},
        {courseName : "Math202", courseImage : 'https://dummyimage.com/318x180/AAAAAA/FFFFFF&text=Default IMG',courseLink:"/course",courseDesc:"aaaaaaaa"}
        ]
};
